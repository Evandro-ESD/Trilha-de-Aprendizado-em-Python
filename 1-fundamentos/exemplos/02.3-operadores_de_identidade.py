...
linguagensDiff = ["python 3"]


def identidadeIS(list1, list2):
    if list1 is list2:
        print("\nSão o mesmo objeto na memória!")
    else:
        print("\nNão são o mesmo objeto, apenas têm valores iguais!")


def identidadeIS_not(list1, list2):
    if list1 is not list2:
        print(f"\nNão são o mesmo objeto na memória!")
    else:
        print("\nSão o mesmo objeto na memória!")
...
identidadeIgualdade(linguagens, linguagensDiff)
print(45 * "_")
